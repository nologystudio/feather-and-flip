	...
	<?php if (strpos(strtoupper($title), 'ABOUT') !== false): // Only for 'about us' page ?>
		<article id="who-we-are">
			...
			<ul>
				<li>
					<figure>
						<img src="/sites/all/themes/feflip/media/about/henley-vazquez.jpg" alt="HENLEY VAZQUEZ, CEO/CO-FOUNDER"/>
					</figure>
                ...
                <li>
                	<figure>
						<img src="/sites/all/themes/feflip/media/about/nikki-ridgway.jpg" alt="NIKKI RIDGWAY, EDITOR/CO-FOUNDER"/>
					</figure>
				...
				<li>
					<figure>
						<img src="sites/all/themes/feflip/media/about/jd-boujnah.jpg" alt="JD BOUJNAH, CREATIVE DIRECTOR/CO-FOUNDER"/>
					</figure>
