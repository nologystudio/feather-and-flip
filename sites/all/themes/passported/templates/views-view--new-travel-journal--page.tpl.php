                ...
                <?php
                    ...
                    foreach ($view->result as $post) {
                        ...
                        switch ($type) {
                            ...
                            default: ?>
                                <a <?php if($i < 9) echo 'data-animate="'.$i.'"'; ?> class="quick-entry <?php if($i >= 9) echo 'hidden'; ?>" data-size="<?php echo $img_wh[0].'x'.$img_wh[1]; ?>" target="_blank" href="<?php echo $post->field_field_original_url[0]['raw']['safe_value']; ?>">
                                    <figure>
