          ...
          <table style="width:640px; margin:auto; padding:0; border-collapse:collapse;">
            ...
            <tr align="center" style="border-bottom: dotted 1px #333333;">
              <td valign="top" style="padding-bottom: 30px;">
                <img style="width:300px; margin: auto;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/feflip_mobile/media/brand/feather-and-flip-black-logo.png"/>
              </td>
            </tr>
            <tr style="height:20px;"></tr>
              ...
              <td>
                <table style="width:100%; border: solid 1px #333333; padding: 60px; border-radius: 5px; margin-bottom: 30px;">
                  <tr>
                    ...
                    <img style="margin: auto;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/feflip_mobile/media/services/expedia-service-email.png"/>
                    </td>
                  </tr>
                  <tr>
            ...
            <tr>
              <td>
                <table style="width:100%; border: solid 1px #333333; padding: 60px; border-radius: 5px; margin-bottom: 30px;">
                  ...
                  <tr>
                    <td style="padding-top: 15px;"><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/feflip_mobile/media/services/expedia-service-email.png"/></td>
            ...
            <tr>
              <td>
                <table style="width:100%; border: solid 1px #333333; padding: 60px; border-radius: 5px; margin-bottom: 30px;">
                  <tr>
                    <td valign="top" style="padding-bottom: 20px;">
                    <img style="margin: auto;" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/feflip_mobile/media/services/f+f-service-email.png"/>
                    </td>
                  </tr>
                  <tr>
                    <td style="color:#333333; font-size:14px; line-height: 22px; border-bottom: dotted 1px #333333; padding-bottom: 15px">The booking you recently made on the featherandflip.com website is confirmed. Your reservation details are below.</td>
